         ...
         <div class="container">
            <div class="hot-products">
               ...
               if(isset($_POST['search-btn'])){
                  $text=$_POST['search'];
                  echo'<h3 class="title"><strong>Sản Phẩm liên quan đến tìm kiếm :</strong> '.$text.'</h3>';
               }else{
                  echo'<h3 class="title"><strong>Sản Phẩm</strong> Hot</h3>';
               }
               ?>
                     ...
                     <div class="row">
                        ...
                        if(isset($_POST['search-btn'])){
                           if($_POST['search']!=null){
                              $search=$_POST['search'];
                           $query = "SELECT product_id, name, description, price, image, category_id, brand_id, origin_id FROM products WHERE name like '%$search%' ";
                           }else{
